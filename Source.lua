-- Justine Hub GUI - Full Script with Rectangular Expansion after Intro
...
-- Create Main Frame (initial small size for intro)
...
-- Expand into rectangle after intro
